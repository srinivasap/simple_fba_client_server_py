...
class Node:
    ...
    def __init__(self, name, endpoint_string, quorum, port):
        self.name = name
...
class UDPTransportProtocol(asyncio.Protocol):
    transport = None
...
class UDPTransport(BaseTransport):
    ...
    def __init__(self, name, endpoint, loop, host, port):
        super(UDPTransport, self).__init__(name, endpoint)
